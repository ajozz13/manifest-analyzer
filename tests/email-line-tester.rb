...
class EmailLineTester < Test::Unit::TestCase
	...
	def test_email_list_should_be_valid
		bad_emails = [ 'aochoa@ibcinc.com', 'frank.martinez@venevicion.net', 'mikemartinez@arruga.net', 'joinme@join.me.ve', 'me124@me.com' ]  ##mike-martinez  and me@me.com should ve invalid with the small regex but ok with the large regex.
		bad_emails.each do |input|
